...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ac97_if_00_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ps2_conn
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = usb_epp_if_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = input_module_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = input_module_1
END
